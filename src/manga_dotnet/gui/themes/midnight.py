"""Midnight blue theme — deep blue palette."""
...
def get_midnight_qss() -> str:
    """Return the complete midnight theme QSS stylesheet."""
    return f"""
/* ── Global ── */
QWidget {{
...
QComboBox QAbstractItemView {{
    ...
    border: 1px solid {_BORDER};
    border-radius: 6px;
    selection-background-color: {_PRIMARY}30;
}}
